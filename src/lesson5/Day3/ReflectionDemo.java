...
public class ReflectionDemo {
	public static void main(String[] args)
		...
		System.out.println("Class Name without package is: " + objClassNoPackage);
		...
		System.out.println("Specific Constructors are: " + constructor.toString() + c.toString());
		...
		// superclasses in that case, superclass of Phonedirectory is the class
		// java.lang.Object
		...
		for (Field oneField : fields) {
			...
			System.out.println("Data type of field " + oneField.getName() + " is: " + oneField.getType());

			// get public field value by passing the Object
			Object value = field.get(rent);
			System.out.println("Value of field " + oneField.getName() + " is: " + value);
